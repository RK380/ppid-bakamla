        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.dashboard')); ?>"> Analitik </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu <?php echo e(request()->routeIs('admin.klasifikasi*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.klasifikasi')); ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu <?php echo e(request()->routeIs('admin.sop*') || request()->routeIs('admin.informasipublik*') || request()->routeIs('admin.pesan*') ? 'active' : ''); ?>">
                        ...
                        <ul class="collapse submenu list-unstyled" id="pages" data-bs-parent="#accordionExample">
                            <li class="<?php echo e(request()->routeIs('admin.sop*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.sop')); ?>"> SOP </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.informasipublik*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.informasipublik')); ?>"> Informasi Publik </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.pesan*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.pesan')); ?>"> Pesan Masuk </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.lokasi*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.lokasi')); ?>"> Lokasi Kantor </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu menu-heading">
                        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>Permohonan Informasi</span></div>
                    </li>
