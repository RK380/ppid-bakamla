...
<section id="hero" class="hero d-flex align-items-center">
    <div class="container">
        ...
        <h4 data-aos="fade-up" data-aos-delay="400" style="text-align: center">Standar Layanan Operasional (PPID)</h4>
        <div class="row">
                ...
                <table id="mySOP" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('download.index', $item->id)); ?>" target="_blank" class="btn btn-sm btn-primary circle"> <i class="ti-download"></i> </a></td>
                        </tr>
