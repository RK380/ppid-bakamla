                                        ...
                                        <div class="timeline-line">
                                            ...
                                            <div class="item-timeline timeline-new">
                                                ...
                                                <div class="t-content">
                                                    ...
                                                    <p>{{ $log->created_at->translatedFormat('d F Y H:i') }} WIB</p>
                                                </div>
                                            </div>
                                            @empty
                                    ...
                                    <div class="vistorsBrowser">
                                        @foreach($browserStats as $browser)
                                            <div class="browser-list">
                                                <div class="w-icon bg-{{ $browser['color'] }}">
                                                    @if($browser['icon']=='chrome')
                                                ...
                                                <div class="w-browser-details">
                                                    <div class="w-browser-info">
                                                        <h6>{{ $browser['browser'] }}</h6>
                                                        <p class="browser-count">{{ $browser['percent'] }}%</p>
                                                    </div>
                                                    <div class="w-browser-stats">
                                                        <div class="progress">
                                                            <div class="progress-bar bg-gradient-{{ $browser['color'] }}"
                                ...
                                <div class="w-chart">
                                    <div class="w-chart-section">
                                        <div class="w-detail">
                                            ...
                                            <p class="w-stats">{{ number_format($total) }}</p>
                                        </div>
                                    ...
                                    <div class="w-chart-section">
                                        <div class="w-detail">
                                            ...
                                            <p class="w-stats">{{ number_format($totalpesanmasuk) }}</p>
                                        </div>
                                        <div class="w-chart-render-one">
                            ...
                            <div class="widget widget-card-four">
                                <div class="widget-content">
                                    ...
                                    <div class="w-content">
                                        ...
                                        <div class="w-info">
                                            <p class="value">{{ number_format($totaldokumen) }} <span>this week</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></p>
                                        </div>
