                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="<?php if(request()->routeIs('admin')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('admin')); ?>"> Analitik </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="<?php echo e(route('admin.klasifikasi')); ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="<?php if(request()->routeIs('admin.klasifikasi')): ?> active <?php endif; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="main-grid-item-icon" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                <ellipse cx="12" cy="5" rx="9" ry="3" />
                                <path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" />
                                <path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" />
                                </svg>
                                <span>Klasifikasi PPID</span>
                            </div>
                        </a>
                    </li>
