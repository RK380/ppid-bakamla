...
<head>
  ...
  <!-- font icons -->
  <!-- <link rel="stylesheet" href=<?php echo e(asset('fe/assets/vendors/themify-icons/css/themify-icons.css')); ?>> -->
...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?php echo e(route('pemohon.register')); ?>" class="<?php if(request()->routeIs('pemohon.register')): ?> active <?php endif; ?>">Permohonan Informasi</a></li>
          <li><a href="https://lpse.bakamla.go.id" class="<?php if(request()->routeIs('pemohon.register')): ?> active <?php endif; ?>">Informasi PBJ</a></li>
          ...
          <li><a href="/statistik" class="<?php if(request()->routeIs('halaman.statistik')): ?> active <?php endif; ?>">Statistik</a></li>
        </ul>
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-4 footer-links">
              ...
              <div class="flicker-img">
                <a href="#">
                    <img src=<?php echo e(asset('assets/img/BIROUM.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
                <a href="#">
                    <img src=<?php echo e(asset('assets/img/DATIN.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
                <a href="#">
                  <img src=<?php echo e(asset('assets/img/INSPEKTORAT.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
                <div class="clearfix"></div>
                <a href="#">
                  <img src=<?php echo e(asset('assets/img/UPH.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
                <a href="#">
                  <img src=<?php echo e(asset('assets/img/OPSLA.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
                <a href="#">
                    <img src=<?php echo e(asset('assets/img/KPIML.png')); ?> style="max-width:100%;heigh:auto;" />
                </a>
  ...
  <!--<script src=<?php echo e(asset('assets/img/DATIN.png')); ?>></script>-->
