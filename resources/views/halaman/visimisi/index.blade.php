...
<!-- Page Title -->
    <div class="page-title" style="background: linear-gradient(rgba(232, 235, 240, 0.5) 28%, rgba(231, 233, 238, 0.8) 70%), url('{{ asset('assets/img/bannerprofile.png')}}');background-size: contain, cover;
