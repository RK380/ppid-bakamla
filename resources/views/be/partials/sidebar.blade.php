                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="@if(request()->routeIs('admin')) active @endif">
                                <a href="{{ route('admin') }}"> Analitik </a>
                            </li>
                            <li class="@if(request()->routeIs('admin.sop')) active @endif">
                                <a href="{{ route('admin.sop') }}"> SOP </a>
                            </li>
                            <li class="@if(request()->routeIs('admin.informasipublik')) active @endif">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.klasifikasi') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="@if(request()->routeIs('admin.klasifikasi')) active @endif">
