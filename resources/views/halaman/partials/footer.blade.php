                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="https://youtube.com/@bakamlariofficial3164?si=kUksChlOiZlc_JSa" target="_BLANK" class="btn-social-modern yt">
                            <img src="{{ asset('assets/img/youtube.png') }}" alt="Youtube"> Youtube
                        </a>
                        <a href="https://www.instagram.com/bakamla_ri/" target="_BLANK" class="btn-social-modern ig">
                            <img src="{{ asset('assets/img/instagram.png') }}" alt="Instagram"> Instagram
                        </a>
                        <a href="https://twitter.com/HumasBakamlaRI" target="_BLANK" class="btn-social-modern tw">
                            <img src="{{ asset('assets/img/twitter.png') }}" alt="Twitter"> Twitter
                        </a>
                        <a href="https://facebook.com/Humas.BakamlaRI/" target="_BLANK" class="btn-social-modern fb">
                            <img src="{{ asset('assets/img/facebook.png')   }}" alt="Facebook"> Facebook Page
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-footer-modern d-flex flex-column p-4">
                    ...
                    <div class="d-flex flex-column gap-2 flex-grow-1 justify-content-center">
                        <div class="stat-row">
                            ...
                            <span class="stat-row-val text-success" id="footer-today">{{ $today }}</span>
                        </div>
                        <div class="stat-row">
                            <span class="stat-row-label">
                            ...
                            <span class="stat-row-val text-primary" id="footer-week">{{ $thisWeek }}</span>
                        </div>
                        <div class="stat-row">
                            <span class="stat-row-label">
                            ...
                            <span class="stat-row-val text-info" id="footer-month">{{ $thisMonth }}</span>
                        </div>
                        <div class="stat-row">
                            <span class="stat-row-label">
                            ...
                            <span class="stat-row-val text-secondary" id="footer-year">{{ $thisYear }}</span>
                        </div>
                        <div class="stat-row total">
                            ...
                            <span class="stat-row-val text-danger" id="footer-total">{{ $total }}</span>
                        </div>
                    </div>
                </div>
            </div>
