      ...
      <div class="content-panel" style="padding:15px;background-color:#f5f5f5;margin-bottom:5px;">
        <div class="content-body-panel">
          <div class="row">
            ...
            <!-- Secara Berkala -->
              <div class="container">
                  <h5 data-aos="fade-up" data-aos-delay="400" style="text-align: center">Daftar Informasi Publik Berkala</h5>
                  <div class="row">
            ...
            {{-- <div class="col-md-12 info-list-panel" style="padding:10px 22px;">
              <div class="row">
                <div class="col-md-1">
                  <div class="thumbnail-list" style="padding: 4px;line-height: 1.42857143;background-color: #fff;border: 1px solid #ddd;border-radius: 4px;transition: border .2s ease-in-out;">
                    <img src="{{ asset('assets/img/uu-bkml.jpg') }}" style="display: block;max-width: 100%;height: auto;margin-left: auto;margin-right: auto;" alt="">
                  </div>
                </div>
                <div class="col-md-11">
                  <p class="list-date" data-asw-orgfontsize="13" style="font-size: 13px;margin-bottom: 5px;color: #525252;">
                    <i class="bi bi-calendar"></i>
                    07 Oktober 2025
                  </p>
                  <h4 class="list-title" data-asw-orgfontsize="16" style="font-size: 16px;">
                    KEP-261-DAFTAR INFORMASI DAN DOKUMENTASI PPID 
                  </h4>
                  <button class="btn btn-outline-danger btn-sm" onclick="window.open('assets/img/KEP-261-DAFTAR INFORMASI DAN DOKUMENTASI PPID.pdf','_blank')">Lihat</button>
                </div>
              </div>
            </div> --}}
